...
export const TrackGrowingTrend: FC<Props> = ({ artist: artistProfile }) => {
  return (
    <section className="grid w-full grid-cols-1 items-center gap-5 p-3 text-center md:grid-cols-2 md:gap-16 md:p-0">
      <div className="relative order-2 min-h-[500px] overflow-hidden rounded-2xl p-2 md:order-1">
