            ...
            <div className="z-20 flex flex-row items-center justify-between gap-3">
              <div className="z-20 flex w-full flex-row items-center justify-between gap-3">
                <div className="flex flex-row items-center gap-3">
                  ...
                  />
                  <div className="w-fit ">
                    <p className="flex w-fit flex-row items-center gap-2 truncate rounded-md font-hubot-sans text-xl">
                      {props.artist.name}
                    </p>
                    <div className="flex flex-row gap-1 text-zinc-400">
                      <Link
                        ...
                        target="__blank"
                        className="truncate transition-colors duration-150 ease-in-out md:hover:text-dot-link-primary"
                      >
