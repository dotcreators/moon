		...
		<>
			<section
				...
				className={classNames(
					"group/main flex w-full flex-col justify-between gap-5 overflow-hidden rounded-2xl bg-dot-primary transition-transform duration-200 ease-in-out py-1",
					props.className,
				)}
			>
				<div className={classNames("relative flex flex-col gap-3 md:gap-5 ")}>
					...
					<div className="flex w-full flex-col gap-3 px-3 pb-3 md:gap-5 md:px-5 md:pb-5">
						...
						{trendsLoading ? (
							...
							<div className="flex w-full text-leftflex-col justify-between gap-3 text-xs md:flex-row md:gap-5">
								<>
