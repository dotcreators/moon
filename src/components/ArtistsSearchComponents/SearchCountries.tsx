    ...
    <section className="overflow-hidden rounded-3xl">
      <button
        ...
        className={classNames(
          'h-15 flex w-full flex-row items-center gap-5 bg-dark-inner p-3 px-5 outline-none transition-colors duration-200 ease-in-out',
          {
      ...
      <section
        className={classNames(
          'flex flex-col gap-2 scroll-smooth rounded-b-3xl bg-dark-inner p-3',
